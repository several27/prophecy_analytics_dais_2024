...
formatted_spend_by_account AS (
  ...
  {#Formats spend data by account, including total clicks, impressions, and spend. The spend amount is displayed in the respective currency (GBP, USD, or as a string).#}
  SELECT 
